...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		// 1-Setup phase
		double balanceBefore = SimpleBankingApp.getBalance("5495-1234"); 
		double withdrawAmount = 50.21;
		// 2-Exercise phase
		SimpleBankingApp.withdrawTransaction("5495-1234", withdrawAmount);
		double balanceAfter = SimpleBankingApp.getBalance("5495-1234");
		// 3-verify
		...
		if (balanceBefore - withdrawAmount == balanceAfter)
			...
			System.out.println(TestUtils.TEXT_COLOR_RED + "testDeposits: TC1 FAILED XXX: balanceBefore + withdrawAmount != balanceAfter");
